...
from config.constants import SECTION_IGNORE_MODS

# GUI
from .simple_section_form import SimpleSectionForm

class IgnoreModsForm(SimpleSectionForm):
    def __init__(self, modloader_controller: GTASAModloaderController, *args, **kwargs):
        super().__init__(
            modloader_controller=modloader_controller, section=SECTION_IGNORE_MODS, *args, **kwargs
        )
